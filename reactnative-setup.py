...
bt_dir = 'C:{ps}Users{ps}lamjo{ps}Desktop{ps}Homework{ps}1 Current Semester{ps}CPSC 411{ps}bundletool-all-1.15.5.jar'.format(ps=path_separator) \
...
distinguished_name = "CN=JonathanLam, OU=CPSC411, O=CSUF, L=Fullerton, ST=California, C=USA"
